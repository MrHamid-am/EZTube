    ...
    public class QueryListViewModel
    {
        ...
        private void InitializeTestList()
        {
            DownloadsList = new BindableCollection<YouTubeVideo>()
            {
                ...
                new YouTubeVideo("3 Scary Game","Mark","5 scary games number 1 bla bla bla...","https://d12avs59aaiyvm.cloudfront.net/wp-content/uploads/2018/02/Markiplier-youtube.jpg"){ProgressState = 25},
